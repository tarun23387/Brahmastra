...
const QUARANTINE = {
  'pyq-2023-071':
    'सूची-मिलान टूटा है — options में असली कूट (जैसे "A-4, B-2, C-1, D-3") हैं ही नहीं, ' +
    'उनकी जगह सूची-I और सूची-II की प्रविष्टियाँ भर गई हैं. सही मिलान: ' +
    'मिरात-ए-सिकन्दरी→गुजरात, बुरहान-ए-माशिर→अहमदनगर, रियाज़-उस-सलातिन→बंगाल, ' +
    'रियाज़-उल-इंशा→महमूद गवां के पत्र. import.js के `match` ढाँचे में ढालिए.',
  'pyq-2024-002':
