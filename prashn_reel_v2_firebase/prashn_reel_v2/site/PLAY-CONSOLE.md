...
तीनों HTML `firebase/public/` में रहती हैं — Hosting का public folder
...
- **Full description यहाँ थी ही नहीं**, जबकि Play उसके बिना listing पूरी नहीं
  मानता। वह अब लिखी जा चुकी है (2020/4000 अक्षर)।
...
`pubspec.yaml` में versionCode ज़रूर बढ़ाइए (अभी `2.0.1+3` → अगली बार `+4`)।
